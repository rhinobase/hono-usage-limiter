...
Thanks for showing interest in contributing to Hono Usage Limiter, you rock!
...
The following steps will get you up and running to contribute to Hono Usage Limiter:

1. Fork the repo (click the `Fork` button at the top right of [this page](https://github.com/rhinobase/hono-usage-limiter))

2. Clone your fork locally

   ```sh
   git clone https://github.com/<your_github_username>/hono-usage-limiter.git
   cd hono-usage-limiter
   ```
...
1. Fork the `hono-usage-limiter` repository and clone your fork
...
3. Make and commit your changes following the [commit convention](https://github.com/rhinobase/hono-usage-limiter/blob/main/CONTRIBUTING.md#commit-convention). As you develop, you can run `pnpm build` and `pnpm test` to make sure everything works as expected.
...
By contributing your code to the `hono-usage-limiter` GitHub repository, you agree to license your contribution under the MIT license.
